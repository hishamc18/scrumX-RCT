      ...
      <div className="grid grid-cols-1 sm:grid-cols-5 gap-[54px]">
        ...
        >
          ...
          <div className="my-14 flex justify-center">
            <img src="/image.png" alt="Create Note Icon" className="w-20 h-20" />
          </div>
        ...
        {notes.map((note, index) => {
          ...
          return (
            ...
            >
              ...
              <p
                className={`text-[11px] mt-2 max-h-[210px] overflow-hidden ${isWhiteBg ? "text-gray-700" : "text-white"
                  }`}
              >
                {note.content}
              </p>
      ...
      <div className="mt-8 mb-8">
        ...
        <input
          ...
          className="text-[24px] bg-transparent border-b-2 border-dashed border-gray-600 w-full mb-4 
            ...
            style={{
              color: newNote.backgroundColor === "bg-pureWhite"
                ? "black" 
          ...
          {colors.map((color) => (
            <button
              ...
              className={`w-6 h-6 rounded-full border-2 border-white shadow-md flex items-center justify-center
                ...
                ${color === "bg-pureWhite" && newNote.backgroundColor === color ? "border-2 border-blue-500 rounded-lg" : ""}`}
            >
