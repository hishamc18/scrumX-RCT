...
const LoginInputField: React.FC<LoginInputFieldProps> = ({ name, id, type = "text", className = "", placeholder = "" }) => {
    ...
    return (
        <div className="relative mb-4">
          ...
          ${showError ? "border-red-500 text-red-700 placeholder-red-500" : "border-gray-300"} ${className}`}
            />
